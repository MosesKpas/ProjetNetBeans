...
public class Menu_tableau extends javax.swing.JFrame {
    ...
    private final String url = "jdbc:mysql://localhost/ma_caisse_remix_2_0";
    ...
    public Menu_tableau() {
        ...
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                if (move == true) {
                    ...
                    //Style
                    style1.setBackground(Color.green);
                ...
                if (move == false) {
                    ...
                    style2.setBackground(Color.green);
                    //Fin Style
                }
            }
        };
        ...
        PANEAUDECONTROL.setVisible(false);
    ...
    private void initComponents() {
        ...
        style1 = new javax.swing.JPanel();
        jLabel39 = new javax.swing.JLabel();
        jLabel45 = new javax.swing.JLabel();
        style2 = new javax.swing.JPanel();
        ...
        boutonclient.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_add_user_group_man_man_30px.png"))); // NOI18N
        ...
        PANEAUDECONTROL.add(boutonclient, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 15, 160, 52));

        boutonoperation.setBackground(new java.awt.Color(255, 255, 255));
        boutonoperation.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        boutonoperation.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_money_26px.png"))); // NOI18N
        ...
        PANEAUDECONTROL.add(boutonoperation, new org.netbeans.lib.awtextra.AbsoluteConstraints(195, 15, 160, 52));

        boutonbilan.setBackground(new java.awt.Color(255, 255, 255));
        boutonbilan.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        boutonbilan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_web_design_30px.png"))); // NOI18N
        ...
        PANEAUDECONTROL.add(boutonbilan, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 15, 160, 52));

        boutonautre.setBackground(new java.awt.Color(255, 255, 255));
        boutonautre.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        boutonautre.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_window_other_24px.png"))); // NOI18N
        ...
        PANEAUDECONTROL.add(boutonautre, new org.netbeans.lib.awtextra.AbsoluteConstraints(545, 15, 160, 52));
        ...
        boutoninfos.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        boutoninfos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_info_24px.png"))); // NOI18N
        ...
        jPanel64.add(boutoninfos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, 130, 40));

        boutonajout.setBackground(new java.awt.Color(0, 204, 204));
        boutonajout.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        boutonajout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_add_user_male_24px_1.png"))); // NOI18N
        ...
        jPanel64.add(boutonajout, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 130, 40));

        boutonmodifier.setBackground(new java.awt.Color(0, 204, 204));
        boutonmodifier.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        boutonmodifier.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_registration_24px.png"))); // NOI18N
        ...
        jPanel64.add(boutonmodifier, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 130, 40));

        jButton19.setBackground(new java.awt.Color(0, 204, 204));
        jButton19.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jButton19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_print_24px.png"))); // NOI18N
        ...
        jPanel64.add(jButton19, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, 130, 40));
        ...
        cherche.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        cherche.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                chercheKeyReleased(evt);
            }
        });
        fondaj.add(cherche, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 40, 190, 40));
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_start_menu_26px.png"))); // NOI18N
        ...
        jPanel48.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 150, 41));
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_high_importance_24px.png"))); // NOI18N
        ...
        jPanel48.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 270, 150, 41));

        jButton7.setBackground(new java.awt.Color(0, 51, 51));
        jButton7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButton7.setForeground(new java.awt.Color(255, 255, 255));
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_phone_24px.png"))); // NOI18N
        ...
        jPanel48.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 340, 150, 41));

        jButton8.setBackground(new java.awt.Color(0, 51, 51));
        jButton8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButton8.setForeground(new java.awt.Color(255, 255, 255));
        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_password_24px.png"))); // NOI18N
        jButton8.setText("M.D.P");
        ...
        jPanel48.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, 150, 41));
        ...
        rfrais.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rfraisActionPerformed(evt);
            }
        });
        ...
        style1.setBackground(new java.awt.Color(255, 51, 51));
        style1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel39.setFont(new java.awt.Font("Glitch Inside", 1, 36)); // NOI18N
        jLabel39.setText("STYLE");
        style1.add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 40, 190, -1));

        jLabel45.setFont(new java.awt.Font("Glitch Inside", 1, 24)); // NOI18N
        jLabel45.setText("Le");
        style1.add(jLabel45, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));

        fondau.add(style1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 510, 260, 90));

        style2.setBackground(new java.awt.Color(0, 255, 0));
        style2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel46.setFont(new java.awt.Font("Glitch Inside", 1, 36)); // NOI18N
        jLabel46.setText("STYLE");
        style2.add(jLabel46, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 40, 180, -1));

        jLabel47.setFont(new java.awt.Font("Glitch Inside", 1, 24)); // NOI18N
        jLabel47.setText("Le");
        style2.add(jLabel47, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));

        fondau.add(style2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 510, 250, 90));
        ...
        jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_delete_user_male_24px.png"))); // NOI18N
        ...
        jPanel66.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 360, 150, 40));

        jButton11.setBackground(new java.awt.Color(255, 255, 0));
        jButton11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButton11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/icons8_data_backup_24px.png"))); // NOI18N
        ...
        jPanel66.add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 310, 150, 40));
    ...
    private void valMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_valMouseClicked
        ...
        try {
            ...
            if (NmU.isEmpty() || MdU.isEmpty()) {
                ...
                verification();
                prendrePourcent(nomusercon.getText());
            }
    ...
    private void boutonajoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boutonajoutActionPerformed
        ...
        try {
            ...
            //si il y a la prescence de l'apostrophe
            if (NOM.contains("'") || NOM.contains(" \" ") || PRENOM.contains("'") || PRENOM.contains("\" ")
                ...
                EnregistrerClient(NOM, POST, PRENOM, SEXE, TEL, CODE, COM, QUAT, AV, NUMP, BIS);
                ...
                d.getDay();
                String DAT = "" + d;
                CompteFranc(NOM, POST, CODE, MOTIF, SOLDE, TOTAL, DAT);
                CompteDollar(NOM, POST, CODE, MOTIF, SOLDE, TOTAL, DAT);
                delInfoTab();
                data();
            }
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try {
            ...
            if (N.contains("'") || N.contains(" \" ") || Pr.contains("'") || Pr.contains("\" ")
                ...
                ModifierClient(N, Ps, Pr, Sx, Tl, fakecode.getText(), Cm, Qu, Av, Nm, Bis);
                delInfoTabmodif();
                dataPourModifier();
            }
        } catch (HeadlessException | NumberFormatException e) {
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try {
            ...
            if (option == JOptionPane.OK_OPTION) {
                effacer(nommd.getText(), postmd.getText());
                delInfoTabmodif();
                dataPourModifier();
            } else {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            verifier_le_client(nomop.getText(), codeop.getText());
            double initial = 0;
            if (entrefranc.getText().isBlank() || entredollar.getText().isBlank() || fraisf.getText().isBlank() || fraisd.getText().isBlank()) {
                caisse_dollar(initial);
                caisse_franc(initial);
                fraisD(initial);
                fraisF(initial);
                voirFD();
                voirFF();
                //JOptionPane.showMessageDialog(null, "Complement de 0");
                entreFranc();
                entreDollar();
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (nomop.getText().isEmpty() && codeop.getText().isEmpty()) {
                ...
                operation();
                ballance_dollar(nomop.getText(), codeop.getText());
                ballance_franc(nomop.getText(), codeop.getText());
                entreDollar();
                entreFranc();
                voirFD();
                voirFF();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Verf_client(nombl.getText(), codebl.getText());
            }
        } catch (Exception e) {
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        try {
            ...
            Verf_client_MDP(nomau.getText(), telau.getText());
        } catch (HeadlessException e) {
             JOptionPane.showMessageDialog(null, "Attention");
        }
    ...
    private void rfraisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rfraisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rfraisActionPerformed
    ...
    private javax.swing.JPanel style1;
    private javax.swing.JPanel style2;
    ...
    private void verification() {
        try {
            ...
            if (rs.next()) {
                //pour les boutons
                principal.setSelectedIndex(1);
                boutonclient.setEnabled(true);
                boutonoperation.setEnabled(true);
                boutonbilan.setEnabled(true);
                boutonautre.setEnabled(true);
                PANEAUDECONTROL.setVisible(true);
                conf.setVisible(false);
                lcl.setBackground(Color.red);
                this.nomusercon.setText("" + nomuser.getText());
                //fin............sinon
            } else if (nomuser.getText().equals("admin") && mdpuser.getText().equals("admin")) {
    ...
    //METHODE POUR ENREGISTRER UN GERANT(E)
    public void saveUserRoot(String N, String P, String S) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String sql = "insert into user values('" + N + "','" + P + "','" + S + "')";
    ...
    //------------------------------------------------PARTIE AJOUT CLIENTS--------------------------------------------------
    //METHODE POUR ENREGISTRER LES CLIENTS
    public void EnregistrerClient(String Nom, String Post, String Pre, String sexe, String tel, String code, String com, String quat, String av, int num, String bis) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String sql = "insert into ajoutclient value('" + Nom + "','" + Post + "','" + Pre + "','" + sexe + "','" + tel + "','" + code + "','" + com + "','" + quat + "','" + av + "','" + num + bis + "')";
            this.st.executeUpdate(sql);
            ...
            JOptionPane.showMessageDialog(null, "Pas d'enregistrement " + e);
        }
    }

    //ENREGISTRER LES CLIENTS DANS LA TABLE DOLLAR
    public void CompteDollar(String nom, String post, String code, String motif, double solde, double total, String date) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String req = "insert into dollar value('" + nom + "','" + post + "','" + code + "','" + motif + "','" + solde + "','" + total + "','" + date + "')";
    ...
    //ENREGISTRER LES CLIENTS DANS LA TABLE FRANC
    public void CompteFranc(String nom, String post, String code, String motif, double solde, double total, String date) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String sql = "insert into franc value('" + nom + "','" + post + "','" + code + "','" + motif + "','" + solde + "','" + total + "','" + date + "')";
            this.st.executeUpdate(sql);
            fermeture();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "compte non ouvert " + e);
    ...
    //METHODE POUR VOIR LES ENREGISTREMENT 
    public void data() {
        try {
            ouverture();
            ...
            while (rs.next()) {
                ...
                String QUAT = rs.getString("quartier");
                String NUMP = rs.getString("Num_parcelle");
                String tdData[] = {NOM + " " + POST + " " + PRE, COM + " " + QUAT + " " + NUMP, TEL};
    ...
    public void effacer(String NOM, String Post) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String req = "delete from ajoutclient where NOM='" + NOM + "' and Postnom='" + Post + "'";
            String req1 = "delete from franc where NOM='" + NOM + "' and Postnom='" + Post + "'";
            String req2 = "delete from dollar where NOM='" + NOM + "' and Postnom='" + Post + "'";
            this.st.executeUpdate(req);
            this.st.executeUpdate(req1);
            this.st.executeUpdate(req2);
            nommd.setText("");
            postmd.setText("");
            premd.setText("");
            nummd.setText("");
            ...
            avmd.setText("");
            fermeture();
            JOptionPane.showMessageDialog(null, "Suppression + Fermeture des comptes");
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
        }
    }

    //DATA POUR L'INTERFACE DES MODIFICATIONS
    public void dataPourModifier() {
        try {
            ...
            while (rs.next()) {
                ...
                fakecode.setText(CODE);
                String FakeCode = "--------";
                String COM = rs.getString("commune");
                String QUAT = rs.getString("quartier");
                String AV = rs.getString("avenue");
                String NUMP = rs.getString("Num_parcelle");
                String tdData[] = {NOM, POST, PRE, SEXE, TEL, FakeCode, COM, QUAT, AV, NUMP};
    ...
    //METHODE POUR MODIFIER LES CLIENTS
    public void ModifierClient(String Nom, String Post, String Pre, String sexe, String tel, String code, String com, String quat, String av, int num, String bis) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String sql = "update ajoutclient set nom ='" + Nom + "' ,postnom ='" + Post + "',"
                    + "prenom ='" + Pre + "', sexe ='" + sexe + "', telephone ='" + tel + "',"
                    + "commune ='" + com + "',quartier ='" + quat + "',"
                    + "avenue ='" + av + "', Num_parcelle ='" + num + bis + "' where nom  ='" + nommemoir.getText() + "'";
            String sql1 = "update franc set nom ='" + Nom + "',postnom ='" + Post + "'  where nom  ='" + nommemoir.getText() + "' " ;
            String sql2 = "update dollar set nom ='" + Nom + "',postnom ='" + Post + "' where nom  ='" + nommemoir.getText() + "' " ;
            this.st.executeUpdate(sql);
    ...
    //METHODE POUR COMPTER LES CLIENTS
    public void compterClient() {
        try {
            ouverture();
            int i = 0;
            this.st = (Statement) this.con.createStatement();
            String sql = "SELECT count(*) AS nblignes from ajoutclient";
            ResultSet rs = st.executeQuery(sql);
            rs.next();
    ...
    //METHODE POUR COMPTER LES CLIENTS (HOMME)
    public void compterHomme() {
        try {
            ouverture();
            int i = 0;
            this.st = (Statement) this.con.createStatement();
            String sql = "SELECT count(*) AS nblignes from ajoutclient where sexe ='Homme'";
            ResultSet rs = st.executeQuery(sql);
            rs.next();
            i = rs.getInt("nblignes");
            ndhomme.setText("" + i);
    ...
    //METHODE POUR COMPTER LES CLIENTS (FEMME)

    public void compterFemme() {
        try {
            ouverture();
            int i = 0;
            this.st = (Statement) this.con.createStatement();
            String sql = "SELECT count(*) AS nblignes from ajoutclient where sexe ='Femme'";
            ResultSet rs = st.executeQuery(sql);
            rs.next();
            i = rs.getInt("nblignes");
            ndfemme.setText("" + i);
    ...
    //METHODE POUR VIDER LE TABLEAU-INFO-(HISTOIRE D'ACTUALISER)
    public void delInfoTabmodif() {
        try {
    ...
    //METHODE D'ACTUALISATION PAR COMMUNE
    public void actualisationCom(String COM) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String sql = "select *from ajoutclient where commune ='" + COM + "'";
            ResultSet rs = st.executeQuery(sql);
            while (rs.next()) {
                String Nm = rs.getString("nom");
                String Pm = rs.getString("postnom");
                String Sx = rs.getString("sexe");
                String Tl = rs.getString("telephone");
                String Cm = rs.getString("commune");
                String sv[] = {Nm, Pm, Sx, Tl, Cm};
                DefaultTableModel model = (DefaultTableModel) tabinfo.getModel();
                model.addRow(sv);
            }
            fermeture();
        } catch (SQLException e) {
    ...
    //METHODE D'ACTUALISATION PAR SEXE
    public void actualisationSX(String Sx) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String sql = "select *from ajoutclient where sexe ='" + Sx + "'";
            ResultSet rs = st.executeQuery(sql);
            while (rs.next()) {
                String Nm = rs.getString("nom");
                String Pm = rs.getString("postnom");
                String Sxe = rs.getString("sexe");
                String Tl = rs.getString("telephone");
                String Cm = rs.getString("commune");
                String sv[] = {Nm, Pm, Sxe, Tl, Cm};
                DefaultTableModel model = (DefaultTableModel) tabinfo.getModel();
                model.addRow(sv);
            }
            fermeture();
    ...
    //METHODE D'ACTUALISATION PAR TELEPHONE
    String Nm;
    String Pm;
    String Sxe;
    String Cm;

    public void actualisationTl(String TL) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String sql = "select telephone from ajoutclient";
            ResultSet rs = st.executeQuery(sql);
            while (rs.next()) {
                String Tl = rs.getString("telephone");
                complement(Tl);
    ...
    //METHODE COMPLEMENTAIRE DE LA RECHERCHE PAR NUM DE TELEPHONE
    public void complement(String c) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "Select *from ajoutclient where telephone ='" + c + "'";
            ResultSet rs = st.executeQuery(req);
            while (rs.next()) {
                Nm = rs.getString("nom");
                Pm = rs.getString("postnom");
                Sxe = rs.getString("sexe");
                Cm = rs.getString("commune");
            }
            fermeture();
        } catch (Exception e) {
        }
    ...
    //METHODE POUR ACTUALISER LE JTABLE APRES SELECTION
    public void delInfoTabInfo() {
        try {
            DefaultTableModel dm = (DefaultTableModel) tabinfo.getModel();
            for (int i = 0; i < dm.getRowCount(); i++) {
                for (int j = 0; j < dm.getColumnCount(); j++) {
                    dm.removeRow(i);
                    dm.setValueAt("", i, j);
    ...
    //----------------------------------------PARTIE DES OPERATIONS---------------------------------------
    //METHODE POUR VERIFIER LE CLIENT
    ...
    //METHODE POUR COMPLETER LE POSTNOM DU CLIENT
    ...
    //METHODE POUR COMPLETER LE PRENOM DU CLIENT
    ...
    //APRES VERIFICATION, ON AFFICHE LE SOLDE EN FRANC DU CLIENT
    ...
    //APRES VERIFICATION ON AFFICHE LE SOLDE EN DOLLAR DU CLIENT
    ...
    //METHODE POUR PRENDRE LE POURCENTAGE
    public void prendrePourcent(String N) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String req = "select frais from user where nom  ='"+N+"'";
            ResultSet rs = this.st.executeQuery(req);
            while (rs.next()) {
                double ag = rs.getDouble("frais");
                pourc.setText("" + ag);
    ...
    //C'EST ICI QUE LON EFFECTUE LES OPERATIONS
    public void operation() {
        //depot
        try {
            Date d = new Date();
            String D = "" + d;
            if (DEPOT.isSelected() && FC.isSelected()) {
                motif = DEPOT.getText();
                double montant_actuel = Double.parseDouble(franc.getText());
                double montant_inserer = Double.parseDouble(inserer.getText());
                double simpleadd = montant_inserer + montant_actuel;
                total.setText(" " + simpleadd);
                JOptionPane.showMessageDialog(null, "Prise du frais " + pourc.getText());
                double frais = Double.parseDouble(pourc.getText());
                double calculeFrais = montant_inserer * frais;//==100
                double calculTotalAF = montant_inserer - calculeFrais;//9900
                double calcultt = simpleadd - calculeFrais;
                total.setText("" + calcultt);

                //bilan
                add_franc(nomop.getText(), postop.getText(), codeop.getText(), motif, inserer.getText(), "" + calcultt, D);
                double prisefrais = Double.parseDouble(entrefranc.getText());
                double totalfrais = prisefrais + montant_inserer;
                //total franc
                double fin = prisefrais + montant_inserer;
                caisse_franc(fin);
                //total frais
                double prendF = Double.parseDouble(fraisf.getText());
                double totalf = calculeFrais + prendF;
                fraisF(totalf);
                JOptionPane.showMessageDialog(null, "Veillez patientez\nFACTURE EN COURS");
                Impri();

            } else if (DEPOT.isSelected() && DL.isSelected()) {
                motif = DEPOT.getText();
                double montant_actuel = Double.parseDouble(dollar.getText());
                double montant_total = Double.parseDouble(inserer.getText());
                double simpleadd = montant_total + montant_actuel;
                total.setText("" + simpleadd);
                JOptionPane.showMessageDialog(null, "Prise du frais " + pourc.getText());
                double frais = Double.parseDouble(pourc.getText());
                double calculeFrais = montant_total * frais;
                double calculTotalAF = montant_total - calculeFrais;
                double calcultt = simpleadd - calculeFrais;
                total.setText("" + calculTotalAF);
                //bilan
                add_dollar(nomop.getText(), postop.getText(), codeop.getText(), motif, inserer.getText(), "" + calcultt, D);
                double prisefrais = Double.parseDouble(entredollar.getText());
                double totalfrais = prisefrais + montant_total;
                //total dollar
                double find  = prisefrais +montant_total;
                caisse_dollar(find);
                //total frais
                double prendF = Double.parseDouble(fraisd.getText());
                double totalf = calculeFrais + prendF;
                fraisD(totalf);
                JOptionPane.showMessageDialog(null, "Veillez patientez\nFACTURE EN COURS");
                Impri();
            } //Retrait
            else if (RETRAIT.isSelected() && FC.isSelected()) {
                motif = RETRAIT.getText();
                double in = Double.parseDouble(inserer.getText());
                ...
                if (in < fc || in <= 0) {
                    ...
                    dell_franc(nomop.getText(), postop.getText(), codeop.getText(), motif, "" + in, "" + montant_total, D);
                    double total = Double.parseDouble(entrefranc.getText());
                    double sous = total - in;
                    dell_caisse_franc(sous);
                    JOptionPane.showMessageDialog(null, "Veillez patientez\nFACTURE EN COURS");
                    Impri();
                } else {
                    JOptionPane.showMessageDialog(null, "Solde insuffisant");
                }
            } else if (RETRAIT.isSelected() && DL.isSelected()) {
                motif = RETRAIT.getText();
                double in = Double.parseDouble(inserer.getText());
                ...
                if (in < dl || in <= 0) {
                    ...
                    total.setText("" + montant_total);
                    //mettre dans la base de donnees
                    dell_dollar(nomop.getText(), postop.getText(), codeop.getText(), motif, "" + in, "" + montant_total, D);
                    double total = Double.parseDouble(entredollar.getText());
                    double sous = total - in;
                    dell_caisse_dollar(sous);
                    JOptionPane.showMessageDialog(null, "Veillez patientez\nFACTURE EN COURS");
                    Impri();
                } else {
                    JOptionPane.showMessageDialog(null, "Solde insufisant");
                }
            } //Aucun choix
            else {
    ...
    //FAIRE UN DEPOT EN FRANC
    public void add_franc(String Nom, String Prenom, String Code, String Motif, String Mt_ins, String Mt_tt, String Date) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String Insert = "insert into franc value('" + Nom + "','" + Prenom + "','" + Code + "','" + Motif + "','" + Mt_ins + "','" + Mt_tt + "','" + Date + "')";
    ...
    //FAIRE UN DEPOT EN DOLLAR
    public void add_dollar(String Nom, String Prenom, String Code, String Motif, String Mt_ins, String Mt_tt, String Date) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String Insert = "insert into dollar value('" + Nom + "','" + Prenom + "','" + Code + "','" + Motif + "','" + Mt_ins + "','" + Mt_tt + "','" + Date + "')";
            this.st.executeUpdate(Insert);
            fermeture();
            JOptionPane.showMessageDialog(null, "Depot effectuer");
        } catch (Exception e) {
    ...
    //FAIRE LE RETRAIT EN FRANC
    public void dell_franc(String Nom, String Prenom, String Code, String Motif, String Mt_ins, String Mt_tt, String Date) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String Insert = "insert into franc value('" + Nom + "','" + Prenom + "','" + Code + "','" + Motif + "','" + Mt_ins + "','" + Mt_tt + "','" + Date + "')";
    ...
    //FAIRE LE RETRAIT EN DOLLAR
    public void dell_dollar(String Nom, String Prenom, String Code, String Motif, String Mt_ins, String Mt_tt, String Date) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String Insert = "insert into dollar value('" + Nom + "','" + Prenom + "','" + Code + "','" + Motif + "','" + Mt_ins + "','" + Mt_tt + "','" + Date + "')";
    ...
    //METHODE POUR VOIR LES ENTREES EN FRANC
    public void entreFranc() {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "select *from lesentreesfranc";
            ResultSet rs = this.st.executeQuery(req);
            while (rs.next()) {
                String TT = rs.getString("montant");
                entrefranc.setText(TT);
            }
            fermeture();

        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "pas de prise " + e);
        }
    }

    //METHODE POUR VOIR LES ENTREES EN DOLLAR
    public void entreDollar() {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "select *from lesentreesdollar";
            ResultSet rs = this.st.executeQuery(req);
            while (rs.next()) {
                String TT = rs.getString("montant");
                entredollar.setText(TT);
            }
            fermeture();
    ...
    //REMPLIR LA CAISSE (EN DOLLAR)
    public void caisse_dollar(double IN) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "insert into lesentreesdollar values ('" + IN + "')";
            this.st.executeUpdate(req);
            fermeture();

        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "pas de in " + e);
        }
    }

    //REMPLIR LA CAISSE (EN FRANC)
    public void caisse_franc(double IN) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "insert into lesentreesfranc values ('" + IN + "')";
            this.st.executeUpdate(req);
            fermeture();
        } catch (SQLException e) {
        }
    ...
    //RETIRER LES ENTRESS EN FRANC
    public void dell_caisse_franc(double in) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "insert into lesentreesfranc values ('" + in + "')";
    ...
    //RETIRER LES ENTREES EN DOLLAR
    public void dell_caisse_dollar(double in) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "insert into lesentreesdollar values ('" + in + "')";
    ...
    //PRENDRE LES FRAIS(FRANC)
    public void fraisF(double F) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "insert into fraisfranc values('" + F + "')";
            this.st.executeUpdate(req);
            fermeture();
    ...
    //PRENDRE LES FRAIS(DOLLAR)
    public void fraisD(double F) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "insert into fraisdollar values('" + F + "')";
            this.st.executeUpdate(req);
            fermeture();
    ...
    //PRENDRE LE FRAIS QUE L'ON POSSEDE EN FRANC
    public void voirFF() {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "select *from fraisfranc";
            ResultSet rs = this.st.executeQuery(req);
            while (rs.next()) {
                String TT = rs.getString("montant");
                fraisf.setText(TT);
    ...
    //PRENDRE LE FRAIS QUE L'ON POSSEDE EN DOLLAR
    public void voirFD() {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "select *from fraisdollar";
            ResultSet rs = this.st.executeQuery(req);
            while (rs.next()) {
                String TT = rs.getString("montant");
                fraisd.setText(TT);
    ...
    //METHODE QUI PERMET DE FAIRE LA FACTURE
    public void Impri() {
        ...
        public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
            ...
            if (pageIndex == 0) {
                ...
                try {
                    ...
                    g2d.drawString("--------------------------------------------------------------", 40, y);
                    y += yshift;
                    g2d.drawString("                       MA CAISSE REMIX 2.0                    ", 40, y);
                    y += yshift;
                    g2d.drawString("--------------------------------------------------------------", 40, y);
                    y += yshift;
                    g2d.drawString(" Nos coordonness                                              ", 40, y);
                    y += yshift;
                    g2d.drawString(" Limete 16ème rue Residentiel N* 30                           ", 40, y);
                    y += yshift;
                    g2d.drawString(" Contact : +243 82 17 12 363                                  ", 40, y);
                    y += yshift;
                    g2d.drawString("--------------------------------------------------------------", 40, y);
                    y += yshift;
                    g2d.drawString("Service de gestion                                            ", 40, y);
                    y += yshift;
                    g2d.drawString("Date    :" + d + "                                                ", 40, y);
                    y += yshift;
                    g2d.drawString("--------------------------------------------------------------", 40, y);
                    y += yshift;
                    g2d.drawString(" IDENTITE DU CLIENT(E      )                                  ", 40, y);
                    y += yshift;
                    g2d.drawString("--------------------------------------------------------------", 40, y);
                    y += yshift;
                    g2d.drawString("                                                              ", 10, y);
                    y += yshift;
                    g2d.drawString("     NOM     : " + nomop.getText() + "                            ", 40, y);
                    y += yshift;
                    g2d.drawString("     POSTNOM : " + postop.getText() + "                           ", 40, y);
                    y += yshift;
                    g2d.drawString("     PRENOM  : " + preop.getText() + "                            ", 40, y);
                    y += yshift;
                    g2d.drawString("                                                              ", 10, y);
                    y += yshift;
                    g2d.drawString("**************************************************************", 40, y);
                    y += yshift;
                    g2d.drawString(" OPERATION EFFECTUER EN CAISSE                                ", 42, y);
                    y += yshift;
                    g2d.drawString("**************************************************************", 40, y);
                    y += yshift;
                    g2d.drawString("     Devise       : " + FC.getText() + "                          ", 30, y);
                    y += yshift;
                    g2d.drawString("     Motif        : " + motif + "                                 ", 30, y);
                    y += yshift;
                    g2d.drawString("     Montant      : " + inserer.getText() + "                     ", 30, y);
                    y += yshift;
                    g2d.drawString("     Frais-Retrait: " + pourc.getText() + "                       ", 30, y);
                    y += yshift;
                    g2d.drawString("     Montant Total: " + total.getText() + "                        ", 30, y);
                    y += yshift;
                    g2d.drawString("--------------------------------------------------------------", 40, y);
                    y += yshift;
                    g2d.drawString(" Signature " + nomop.getText() + "            Signé par " + nomusercon.getText() + " ", 55, y);
                    y += yshift;
                    g2d.drawString("                                                              ", 12, y);
                    y += yshift;
                    g2d.drawString("--------------------------------------------------------------", 40, y);
    ...
    //UNE VALEUR DE LA FACTURE
    protected static double cm_to_pp(double cm) {
        return toPPI(cm * 0.393600787);
    }

    //UNE AUTRE VALEUR DE CONVERSION DE LA FACTURE
    protected static double toPPI(double inch) {
        return inch * 100d;
    }

    //--------------------------------------------------PARTIE DU BILAN-----------------------------------------
    //VERIFIER LE CLIENT DU COTE BILAN
    public void Verf_client(String NOM, String CODE) {
        try {
            ouverture();
            com.mysql.jdbc.Statement stm = (com.mysql.jdbc.Statement) con.createStatement();
            String sql = "select * from ajoutclient where NOM ='" + NOM + "' and code = '" + CODE + "'";
            ResultSet rs = stm.executeQuery(sql);
            if (rs.next()) {
                completer_le_postnom_Bl(NOM, CODE);
                completer_le_prenom_Bl(NOM, CODE);
                verf_franc(NOM, CODE);
                verf_dollar(NOM, CODE);
                ballance_franc_Bl(NOM, CODE);
                ballance_dollar_Bl(NOM, CODE);
            } else {
                JOptionPane.showMessageDialog(this, "Oups!! \nNom ou Mot de passe incorrect");
                nombl.setText("");
                codebl.setText(null);
    ...
    //METHODE POUR COMPLETER LE POSTNOM DU CLIENT(BILAN)

    public void completer_le_postnom_Bl(String Nom, String Code) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String rech = "Select postnom from ajoutclient where nom='" + Nom + "' and code='" + Code + "'  ";
    ...
    //METHODE POUR COMPLETER LE PRENOM DU CLIENT(BILAN)
    public void completer_le_prenom_Bl(String Nom, String Code) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String rech = "Select prenom from ajoutclient where nom='" + Nom + "' and code='" + Code + "' ";
    ...
    //PRENDRE LE FRANC QUE LE CLIENT POSSEDE POUR LE METTRE DANS LE JTABLE
    public void verf_franc(String NOM, String CODE) {
        try {
            ...
            while (rs.next()) {
                String Nom = rs.getString("nom");
                String PRENOM = rs.getString("postnom");
                ...
                DefaultTableModel tbModel = (DefaultTableModel) tabbl.getModel();
                tbModel.addRow(tdData);
            }
            fermeture();
        } catch (Exception e) {
    ...
    //PRENDRE LE DOLLAR QUE LE CLIENT POSSEDE POUR LE METTRE DANS LE JTABLE
    ...
    public void ballance_franc_Bl(String NOM, String CODE) {
        try {
            ouverture();
            com.mysql.jdbc.Statement stm = (com.mysql.jdbc.Statement) con.createStatement();
            String sql = "select total from franc where NOM ='" + NOM + "' and code = '" + CODE + "'";
            ...
            JOptionPane.showMessageDialog(null, "Pas de verification");
        }
    }
    //APRES VERIFICATION ON AFFICHE LE SOLDE EN DOLLAR DU CLIENT

    public void ballance_dollar_Bl(String NOM, String CODE) {
        try {
            ouverture();
            com.mysql.jdbc.Statement stm = (com.mysql.jdbc.Statement) con.createStatement();
            String sql = "select total from dollar where NOM ='" + NOM + "' and code = '" + CODE + "'";
    ...
    //---------------------------------------------PARTIE AUTRE-----------------------------------------------
    //RETIRER DU FRAIS EN FRANC QUE L'ON POSSEDE
    public void rfranc(double in) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String sql = "insert into fraisfranc values('" + in + "')";
            this.st.executeUpdate(sql);
            fermeture();
            JOptionPane.showMessageDialog(null, "RETRAIT EFFECTUER");
        } catch (SQLException e) {
    ...
    //RETIRER DU FRAIS EN DOLLAR QUE L'ON POSSEDE
    public void rdollar(double in) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String sql = "insert into fraisdollar values('" + in + "')";
            this.st.executeUpdate(sql);
            fermeture();
            JOptionPane.showMessageDialog(null, "RETRAIT EFFECTUER");
        } catch (SQLException e) {
    ...
    //MODIFIER LE TAUX DU FRAIS 
    public void changefrais(double in) {
        try {
            ouverture();
            this.st = (Statement) this.con.createStatement();
            String req = "update user set frais ='" + in + "' where nom ='" + nomusercon.getText() + "'";
            this.st.executeUpdate(req);
            fermeture();
            JOptionPane.showMessageDialog(null, "MODIFICATION EFFECTUER");
            modiff.setText("");
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "PAS DE MOFICATION " + e);
        }
    }
    

 //VERIFIER LE CLIENT DU COTE AUTRE (MODIFIER LE MOT DF PASSE)
    public void Verf_client_MDP(String NOM, String CODE) {
        try {
            ouverture();
            com.mysql.jdbc.Statement stm = (com.mysql.jdbc.Statement) con.createStatement();
            String sql = "select * from ajoutclient where NOM ='" + NOM + "' and telephone = '" + CODE + "'";
            ResultSet rs = stm.executeQuery(sql);
            if (rs.next()) {
                completer_le_postnom_AU(NOM, CODE);
                completer_le_prenom_AU(NOM, CODE);
            } else {
    ...
    //METHODE POUR COMPLETER LE PRENOM DU CLIENT(AUTRE)
    public void completer_le_postnom_AU(String Nom, String Code) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String rech = "Select postnom from ajoutclient where nom='" + Nom + "' and telephone='" + Code + "'  ";
            ResultSet rs = this.st.executeQuery(rech);
            while (rs.next()) {
                String n = rs.getString("postnom");
                postau.setText(n);
    ...
    //METHODE POUR COMPLETER LE PRENOM DU CLIENT(AUTRE)
    public void completer_le_prenom_AU(String Nom, String Code) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String rech = "Select prenom from ajoutclient where nom='" + Nom + "' and telephone='" + Code + "' ";
            ResultSet rs = this.st.executeQuery(rech);
            while (rs.next()) {
                String n = rs.getString("prenom");
                preau.setText(n);
    ...
    //METHODE POUR MODIFIER LE MOT DE PASSE DES CLIENTS
    public void modif_Code(String Nom) {
        try {
            ouverture();
            this.st = (com.mysql.jdbc.Statement) this.con.createStatement();
            String sql = "update ajoutclient set code ='" + Nom + "' where nom  ='" + nomau.getText() + "'";
            String sql1 = "update franc set code ='" + Nom + "' where nom  ='" + nomau.getText() + "'";
            String sql2 = "update dollar set code ='" + Nom + "'where nom  ='" + nomau.getText() + "'";
            this.st.executeUpdate(sql);
            this.st.executeUpdate(sql1);
            this.st.executeUpdate(sql2);
            this.st.executeUpdate(sql);
