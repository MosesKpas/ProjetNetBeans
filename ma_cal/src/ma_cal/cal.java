...
public class cal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(29, 29, 29)
                .addComponent(ec, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        if (e.contains("+")){
            ...
            if ( matcher.find() ) { // si on trouve
                String nombre = matcher.group(0); // on récupère ce qui a été trouvé
        ...
        int b =0;
         ...
         String strr = ""+ec.getText();
         Pattern patterne = Pattern.compile("[^\\d]*[\\d]+[^\\d]+([\\d]+)");
         Matcher matcherr = patterne.matcher(strr);
         System.out.println(strr);
         if (matcherr.find()) 
         {
             System.out.println(matcherr.group(1));
             b = Integer.parseInt(matcherr.group(1));
         }
        ...
        double b =0;
         ...
         {
             System.out.println(matcherr.group(1));
             b = Double.parseDouble(matcherr.group(1));
         }
         System.out.println("a = "+a+" et b ="+b);
         double c = a/b;
         ec.setText(""+c);
    ...
    public String getNbr(String str){
