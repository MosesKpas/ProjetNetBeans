...
public class fen0 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        principal.addTab("tab4", jPanel30);
    ...
    private void bsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsaveActionPerformed
        ...
        boolean selectBis = bis.isSelected();
        if (selectBis = true) {
            numpA = numpA + " bis";
...
// depot
            if (choixDepot.isSelected()) {
                boolean compt = choixDollar.isSelected();
                boolean compt1 = choixFranc.isSelected();
                // dollar
                if (choixDollar.isSelected()) {
                    String motif = "depot";  // motif
                    // recuperation du montant inserer
                    double montantInserer = Double.parseDouble(insert.getText());
                    ...
                    if (montantInserer > 0) {
                        ...
                        // somme
                        double nouveauMontant = montantInserer + montantActuel;
                        ...
                        double nouveauBilan = montantBilanActuel + montantInserer;
...
//bilanFran.setText("");
                ...
                if (choixFranc.isSelected()) {
                    ...
                    if (nouveauMontant >= 0) {
                        ...
                        depotFranc(nom1.getText(), post1.getText(), pre1.getText(), "retrait", montantInserer, nouveauMontant, date.getText() + " " + heure.getText());
...
//bilanFran.setText("");
                ...
                JOptionPane.showMessageDialog(null, " Tu sais pas choisir ?? TON ONCLE \n depot ou retrait");
            }
            nom1.setText("");
            mdp.setText("");
            post1.setText("");
